            ...
            @if($portfolioItems->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    @foreach($portfolioItems as $item)
                        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group border border-gray-100 dark:border-gray-700/70">
                            {{-- Portfolio Image --}}
                            <div class="relative overflow-hidden aspect-video bg-gray-200 dark:bg-gray-700">
                                ...
                                @if($item->category)
                                    <div class="absolute top-4 left-4">
                                        <span class="px-3 py-1 bg-white/90 backdrop-blur-sm text-purple-700 text-sm font-semibold rounded-full">
                                ...
                                @if($item->rating)
                                    <div class="absolute top-4 right-4">
                                        <div class="flex items-center gap-1 px-2 py-1 bg-yellow-400/90 backdrop-blur-sm rounded-full">
                                            ...
                                            <span class="text-sm font-bold text-yellow-800">{{ $item->rating }}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <a href="{{ route('portfolio.show', $item->slug) }}"
                                   class="inline-flex items-center justify-center w-full px-6 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors">
                                    Lihat Detail
